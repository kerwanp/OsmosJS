...
1. **Fork and clone the repository**
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/osmos.git
   cd osmos
   ```
...
Please check out the [open issues](https://github.com/kerwanp/osmosjs/issues). Issues labelled [**Good First Issue**](https://github.com/kerwanp/osmosjs/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) are especially good to start with.
...
- **ESLint**: Follow our custom ESLint configuration (`@osmosjs/eslint-config`)
...
- Open an [issue](https://github.com/kerwanp/osmosjs/issues) for bugs or feature requests
- Join our community discussions
- Check existing issues and pull requests for similar problems

Thank you for contributing to Osmos! 🎉
