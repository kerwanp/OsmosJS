...
We take the security of Osmos seriously. If you believe you have found a security vulnerability, please report it to us as described below.

**Please do not report security vulnerabilities through public GitHub issues, discussions, or pull requests.**

### Reporting via GitHub Security Tab

1. Go to the [Security tab](https://github.com/kerwanp/osmosjs/security/advisories) on our GitHub repository
...
**Subject:** [SECURITY] Osmos Security Vulnerability Report
...
- **GitHub Security Tab**: [Security Advisories](https://github.com/kerwanp/osmosjs/security/advisories)

Thank you for helping keep Osmos secure!
